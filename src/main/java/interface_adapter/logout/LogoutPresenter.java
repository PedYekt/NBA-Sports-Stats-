...
public class LogoutPresenter implements LogoutOutputBoundary {
    ...
    public void prepareSuccessView(LogoutOutputData response) {
        ...
        final LoggedInState tmpLoggedInState = this.loggedInViewModel.getState();
        tmpLoggedInState.setUsername("");
        this.loggedInViewModel.setState(tmpLoggedInState);
        ...
        final LoginState tmpLogInState = this.loginViewModel.getState();
        tmpLogInState.setPassword("");
        tmpLogInState.setUsername("");
        this.loginViewModel.setState(tmpLogInState);
